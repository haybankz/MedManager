    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                values.put(UserEntry.COLUMN_USER_PROFILE_ID, "");
                values.put(UserEntry.COLUMN_USER_EMAIL, email);
                values.put(UserEntry.COLUMN_USER_FAMILY_NAME, firstName);
                values.put(UserEntry.COLUMN_USER_GIVEN_NAME, lastName);
                values.put(UserEntry.COLUMN_USER_DISPLAY_NAME, firstName +" "+ lastName);
                values.put(UserEntry.COLUMN_USER_PHOTO_URL, profilePicUrl);
                values.put(UserEntry.COLUMN_USER_PASSWORD, password);

                int i = UserDbUtils.signUp(mContext, values);
